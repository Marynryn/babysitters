...
export default function Home() {
    ...
    return (
        ...
        <div className=" bg-teal-900 bg bg-cover bg-center text-white  rounded-3xl relative" style={{
            ...
            width: "calc(100 % - (32 / 1440 * 100%))",
            padding: "20px calc(96 / 1376 * 100%) 50px calc(96 / 1376 * 100%)",
        }} >
            <Header />
            <div className=' bg-stone-200 absolute left-0 mt-4' style={{ height: "1px" }} ></div>
            <h1 className="font-medium text-4xl  md:text-5xl lg:text-6xl xl:text-7xl  mt-48" style={{ width: "calc(517 / 1184 * 100%)" }} >Make Life Easier for the Family:</h1>
            <p className="text-2xl font-normal mt-7 mb-16 " style={{ width: "calc(517 / 1184 * 100%)" }}>Find Babysitters Online for All Occasions</p>
            ...
            <div className=" p-4 bg-white rounded-2xl ml-auto flex items-center lg:p-8 xl:-mr-11" style={{ height: "118", maxWidth: "284px", }}>
