    ...
    return (
        <div className=" m-4 bg-teal-900 bg-cover bg-center text-white h-min rounded-3xl lg:m-6 xl:m-8 " style={{ backgroundImage: 'url(/img/bg1.png)' }}>
            <div className={css.bg}>
                <div className="pb-12 pt-5 px-4 xl:px-24 relative">
                    <Header />
                    <h1 className="font-medium text-4xl mt-10 md:text-5xl lg:text-6xl xl:text-7xl w-3/6 xl:mt-48">Make Life Easier for the Family:</h1>
                    ...
                    <div className="w-72 h-28 bg-white rounded-2xl mr-0 ml-auto flex p-8 ">
